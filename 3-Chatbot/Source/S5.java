...
public class S5 {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        String userProfile = "C:/Users/avalon/AppData/Local/Google/Chrome/User Data/Profile 2";
        ChromeOptions options = new ChromeOptions();
        options.addArguments("user-data-dir=" + userProfile);
        
        WebDriver driver = new ChromeDriver(options);//new FirefoxDriver();
        //URL to testing console
        String baseUrl = "https://developer.amazon.com/alexa/console/ask/test/UPDATE_THE_URL_TO_CONSOLE....";
        driver.get(baseUrl); 
        //Testing console sign in credentials
        driver.findElement(By.id("ap_email")).sendKeys("UPDATE WITH USERNAME");
        driver.findElement(By.id("continue")).click();
        driver.findElement(By.id("ap_password")).sendKeys("UPDATE WITH PASSWORD");
        ...
        for (String n : names.get(0)) {
            ...
            while (!isNull) {
                ...
                //Extract the skill name and then fetch the skill id etc- JA
                String skill_name;
                if (name.toLowerCase().startsWith("open"))
                {
                 skill_name = name;
                ...
                for (Row row : sheet) {
                // check if ID in first cell of row matches given ID
                Cell firstCell = row.getCell(0);
                if (firstCell != null && firstCell.getCellType() == Cell.CELL_TYPE_STRING && firstCell.getStringCellValue().equals(skill_name)) {
                    // if ID matches, store column values in variables
                    String asin = row.getCell(1).getStringCellValue();
                    ...
                    break; // exit loop after first matching row is found
                    }
                }
                ...
                driver.findElement(By.xpath("//*[@id=\"astro-tabs-1-panel-0\"]/div[1]/div[2]/div[1]/div[1]/input")).sendKeys(name);
                Thread.sleep(5000);
                driver.findElement(By.xpath("//*[@id=\"astro-tabs-1-panel-0\"]/div[1]/div[2]/div[1]/div[1]/input")).sendKeys(Keys.ENTER);
                ...
                String question = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/section[2]/div[2]/div[2]/div[1]/p")).getText(), testQ = "";
                
                if (question == null || question.isEmpty()){
                                        
                    WebElement element = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/section[2]/div[2]/div[2]/div[1]/p"));
                    try{        
                    WebDriverWait wait = new WebDriverWait(driver, 30);
                    wait.until(ExpectedConditions.and(
                    ExpectedConditions.visibilityOf(element),
                    ExpectedConditions.not(ExpectedConditions.textToBe(By.xpath("//*[@id=\"root\"]/div/div/section[2]/div[2]/div[2]/div[1]/p"),""))
                    ));
                    }
                ...
                Date questtime = new Date();
                String timestampquest = dateFormat.format(questtime);
                ...
                if (response.exists() && response.isFile()) {
                    Date stoptime = new Date();
                    String stoptimestamp = dateFormat.format(stoptime);
                    System.out.println("STOP/EXIT command  "+ stoptimestamp+"\n\n");
                    exit(driver);
                    response.delete();
                }
                ...
                int times = 0;
                Thread.sleep(2000);//adding wait of 2 seconds to let the new question (if there is any) load //JA
                while (times < 2500) {
                    testQ = question;
                    question = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/section[2]/div[2]/div[2]/div[1]/p")).getText();
                ...
                try {
                    ...
                    System.out.println("Error......INDEXOUTOFBND*");
                    maps.remove(0);
                    isNull = true;
                }
    ...
    public static void exit(WebDriver driver) throws InterruptedException {
        driver.findElement(By.xpath("//*[@id=\"astro-tabs-1-panel-0\"]/div[1]/div[2]/div[1]/div[1]/input")).sendKeys("Stop");
        driver.findElement(By.xpath("//*[@id=\"astro-tabs-1-panel-0\"]/div[1]/div[2]/div[1]/div[1]/input")).sendKeys(Keys.ENTER);
        Thread.sleep(1500);
        driver.findElement(By.xpath("//*[@id=\"astro-tabs-1-panel-0\"]/div[1]/div[2]/div[1]/div[1]/input")).sendKeys("Exit");
        driver.findElement(By.xpath("//*[@id=\"astro-tabs-1-panel-0\"]/div[1]/div[2]/div[1]/div[1]/input")).sendKeys(Keys.ENTER);
        
        //Making the input elements disabled in case of non-compliance detection
        WebElement element_for_input = driver.findElement(By.xpath("//*[@id=\"astro-tabs-1-panel-0\"]/div[1]"));
        JavascriptExecutor jsExe = (JavascriptExecutor) driver;
        jsExe.executeScript("arguments[0].style.display = 'none';", element_for_input);
        Thread.sleep(5000);
        jsExe.executeScript("arguments[0].style.display = '';", element_for_input);
